          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="ml-xl-3 login active"><a href="login.php"><span class="border-left pl-xl-4"></span>S'identifier</a></li>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7 mb-5"  data-aos="fade">
            ...
            <form action="Controller/loginDAO.php" class="p-5 bg-white" method="post">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Connexion" class="btn btn-primary py-2 px-4 text-white">
                </div>
              </div>
